...
![](https://komarev.com/ghpvc/?username=elemeNtk0)
...
## 🧑‍💻 Опыт
Фронтенд-разработчик с коммерческим опытом в вэбе с 2011г. Прошёл эволюцию от вёрстки и работы с CMS до создания сложных SPA-приложений на **React и TypeScript**. 
Последние 5-6 лет акцент именно на SPA. Также есть опыт наставничества и системного улучшения рабочих процессов.

Мне инетересно:
- Написание качественного кода.
- Внедрение дизайн-систем, линтеров.
...
**Также работаю с:**  
`Storybook` `CSS Modules` `БЭМ` `Design Tokens` `ESLint` `Stylelint` `React Testing Library` `CI/CD` `Jira` `YouTrack` `Яндек Трекер`
